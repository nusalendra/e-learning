                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="{{ $data->nama }}" placeholder="Masukkan Nama Siswa" name="nama" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ $data->dataOrangTua->nama_ayah }}" type="text" placeholder="Masukkan Nama Ayah" name="nama_ayah" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nama_ibu" class="form-control-label">Nama Ibu</label>
                            <input class="form-control" value="{{ $data->dataOrangTua->nama_ibu }}" type="text" placeholder="Masukkan Nama Ibu" name="nama_ibu" disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ $data->dataOrangTua->pekerjaan_ayah }}" type="text" placeholder="Masukkan Pekerjaan Ayah" name="pekerjaan_ayah" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="pekerjaan_ibu" class="form-control-label">Pekerjaan Ibu</label>
                            <input class="form-control" value="{{ $data->dataOrangTua->pekerjaan_ibu }}" type="text" placeholder="Masukkan Pekerjaan Ibu" name="pekerjaan_ibu" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ $data->dataOrangTua->jalan }}" type="text" placeholder="Masukkan Jalan" name="jalan" disabled>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="kelurahan" class="form-control-label">Kelurahan</label>
                            <input class="form-control" value="{{ $data->dataOrangTua->kelurahan }}" type="text" placeholder="Masukkan Kelurahan" name="kelurahan" disabled>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="kecamatan" class="form-control-label">Kecamatan</label>
                            <input class="form-control" value="{{ $data->dataOrangTua->kecamatan }}" type="text" placeholder="Masukkan Kecamatan" name="kecamatan" disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ $data->dataOrangTua->kota }}" type="text" placeholder="Masukkan Kota" name="kota" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="provinsi" class="form-control-label">Provinsi</label>
                            <input class="form-control" value="{{ $data->dataOrangTua->provinsi }}" type="text" placeholder="Masukkan Pekerjaan Ibu" name="provinsi" disabled>
                        </div>
                    </div>
                </div>
