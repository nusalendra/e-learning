                        ...
                        <table id="myTable" class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-xs font-weight-bolder">Tanggal Mulai - Akhir</th>
                                ...
                                @foreach ($data as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $item->semester->awal_tahun_ajaran }}/{{ $item->semester->akhir_tahun_ajaran }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">
                                                        {{ \Carbon\Carbon::parse($item->semester->tanggal_mulai)->locale('id')->translatedFormat('d F Y') }}
                                                        -
                                                        {{ \Carbon\Carbon::parse($item->semester->tanggal_akhir)->locale('id')->translatedFormat('d F Y') }}
                                            ...
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    @if ($item->status == 'Non Aktif')
                                                        <form action="/semester/{{ $item->id }}/ubah-status"
