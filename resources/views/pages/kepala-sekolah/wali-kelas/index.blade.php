                                ...
                                @foreach ($data as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    @if ($item->waliKelas->kelas)
                                                        <h6 class="mb-0 text-sm">{{ $item->waliKelas->kelas->nama }}</h6>
                                                    @else
                                                        <h6 class="mb-0 text-sm text-danger">Kelas Tidak Terdaftar!</h6>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <a href="/wali-kelas/{{ $item->id }}/edit">
                                                ...
                                                <div class="ms-2 d-flex flex-column justify-content-center">
                                                    <form action="/wali-kelas/{{ $item->id }}" method="POST" role="form text-left">
                                                        @csrf
                                                        @method('DELETE')
