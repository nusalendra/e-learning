                                ...
                                @foreach ($data as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <a href="/validasi-rapor/check-rapor-pdf/{{ $item->id }}" target="_blank"> 
                                                        <button type="button" class="btn bg-gradient-dark">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" fill="currentColor" class="bi bi-back me-1 mb-1"
                                                                viewBox="0 0 16 16">
                                                                <path
                                                ...
                                                <div class="ms-2 d-flex flex-column justify-content-center">
                                                    <a href="/validasi-rapor/mata-pelajaran-siswa/{{ $item->id }}">
