                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="mata_pelajaran_id" class="form-control-label">Mata Pelajaran <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="nama_tugas" class="form-control-label">Nama Tugas <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" placeholder="Masukkan Nama Tugas" name="nama_tugas" required>
                        </div>
                        <div class="form-group">
                            <label for="upload_tugas" class="form-control-label">Upload Tugas <span class="text-danger">*</span></label>
