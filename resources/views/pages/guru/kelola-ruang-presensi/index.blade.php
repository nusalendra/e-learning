...
@section('content')
    <div>
        <div class="text-end">
            <a href="/kelola-ruang-presensi-guru/create">
                                ...
                                @foreach ($data as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <a href="/kelola-ruang-presensi-guru/{{ $item->id }}/edit">
                                                ...
                                                <div class="ms-2 d-flex flex-column justify-content-center">
                                                    <form action="/kelola-ruang-presensi-guru/{{ $item->id }}" method="POST" role="form text-left">
                                                        @csrf
                                                        @method('DELETE')
