    ...
    <div class="container-fluid py-2">
        ...
        <div class="card mt-4 mx-5 px-4 py-3">
            <div class="card-body pt-4 p-3">
                <form action="/capaian-kompetensi/input-capaian-kompetensi" method="POST" role="form text-left">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="/capaian-kompetensi/{{ $nilaiMataPelajaran->siswaMataPelajaran->siswa_id }}"
                                ...
                                @foreach ($capaianKompetensi as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <a href="/capaian-kompetensi/{{ $item->id }}/show-capaian-kompetensi">
                                                ...
                                                <div class="ms-2 d-flex flex-column justify-content-center">
                                                    <form action="/capaian-kompetensi/{{ $item->id }}" method="POST"
                                                        role="form text-left">
                                                        @csrf
                                                        @method('DELETE')
                                                        <input type="hidden" value="{{ $nilaiMataPelajaran->id }}" name="nilai_mata_pelajaran_id">
