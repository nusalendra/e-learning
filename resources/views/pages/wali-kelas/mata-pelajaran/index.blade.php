                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="ms-2 d-flex flex-column justify-content-center">
                                                    <a href="/mata-pelajaran/{{ $item->id }}/edit">
                                                ...
                                                <div class="ms-2 d-flex flex-column justify-content-center">
                                                    <form action="/mata-pelajaran/{{ $item->id }}" method="POST" role="form text-left">
                                                        @csrf
                                                        @method('DELETE')
