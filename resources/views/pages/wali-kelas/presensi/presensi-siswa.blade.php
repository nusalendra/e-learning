                                            ...
                                            <td>
                                                <div class="d-flex px-3 py-1">
                                                    <select name="status_presensi[]" class="form-select ">
                                                        @if($item->presensi->isNotEmpty())
                                                            <option value="Hadir" {{ $item->presensi->first()->status_presensi === 'Hadir' ? 'selected' : '' }}>Hadir</option>
                                                            <option value="Izin" {{ $item->presensi->first()->status_presensi === 'Izin' ? 'selected' : '' }}>Izin</option>
                                                            <option value="Tanpa Keterangan" {{ $item->presensi->first()->status_presensi === 'Tanpa Keterangan' ? 'selected' : '' }}>Tanpa Keterangan</option>
                                                        @else
