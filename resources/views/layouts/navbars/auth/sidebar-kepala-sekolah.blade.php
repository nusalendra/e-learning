...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
  <div class="sidenav-header mb-7">
    <a class="align-items-center justify-content-center d-flex m-0 navbar-brand" href="{{ route('dashboard-kepala-sekolah') }}">
  ...
  <div class="collapse navbar-collapse h-auto w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('dashboard-kepala-sekolah') ? 'active' : '') }}" href="{{ url('dashboard-kepala-sekolah') }}">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('tenaga-pengajar') ? 'active' : '') }} " href="{{ url('tenaga-pengajar') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Tenaga Pengajar</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('identitas-siswa') ? 'active' : '') }} " href="{{ url('identitas-siswa') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Identitas Siswa</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('laporan-nilai-siswa') ? 'active' : '') }} " href="{{ url('laporan-nilai-siswa') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark" viewBox="0 0 16 16">
                <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5z"/>
              </svg>
            </div>
            <span class="nav-link-text ms-1">Laporan Nilai Siswa</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('laporan-presensi-siswa') ? 'active' : '') }} " href="{{ url('laporan-presensi-siswa') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Laporan Presensi Siswa</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('validasi-rapor') ? 'active' : '') }} " href="{{ url('validasi-rapor') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Validasi Rapor</span>
        </a>
      </li>
